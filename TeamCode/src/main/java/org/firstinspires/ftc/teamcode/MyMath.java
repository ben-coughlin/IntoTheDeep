...
public class MyMath {
     ...
     */
    public static PointDouble lineIntersecion(PointDouble point1, double m1, PointDouble point2, double m2){
        ...
        return new PointDouble(xIntercept,yIntercept);
    }
     ...
     */
    public static ArrayList<PointDouble> lineCircleIntersection(double circleX, double circleY, double r,
        ...
        ArrayList<PointDouble> allPoints = new ArrayList<>();
        ...
        try{
            ...
            if(xRoot1 > minX && xRoot1 < maxX){
                allPoints.add(new PointDouble(xRoot1,yRoot1));
            }
            ...
            if(xRoot2 > minX && xRoot2 < maxX){
                allPoints.add(new PointDouble(xRoot2,yRoot2));
            }
        }catch(Exception e){
